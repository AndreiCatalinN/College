/**
Program description:
Finds the smallest and biggest number, the biggest
 perfect number and the biggest prime number in array
 Also counts how many times the biggest number appears
